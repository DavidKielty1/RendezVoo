...
export const env = createEnv({
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_GITHUB_CLIENT_ID_DEV: process.env.GITHUB_CLIENT_ID,
    NEXT_PUBLIC_GITHUB_CLIENT_SECRET_DEV: process.env.GITHUB_CLIENT_SECRET,
    NEXT_PUBLIC_GITHUB_CLIENT_ID_PROD:
