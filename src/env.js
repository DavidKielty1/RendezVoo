...
export const env = createEnv({
  ...
  runtimeEnv: {
    ...
    GITHUB_CLIENT_ID_DEV: process.env.GITHUB_CLIENT_ID,
    GITHUB_CLIENT_SECRET_DEV: process.env.GITHUB_CLIENT_SECRET,
    GITHUB_CLIENT_ID_PROD: process.env.GITHUB_CLIENT_ID,
    GITHUB_CLIENT_SECRET_PROD: process.env.GITHUB_CLIENT_SECRET,
    ...
    NEXT_PUBLIC_GITHUB_CLIENT_ID_DEV:
      process.env.NEXT_PUBLIC__GITHUB_CLIENT_ID_DEV,
